...
-   [JQuery Ajax Tutorial #1 - Using AJAX & APIâ€™s](https://intranet.alxswe.com/rltoken/gMwyXisSLu-kZicmGA0-LQ "JQuery Ajax Tutorial #1 - Using AJAX & API's")
...
-   The translation of â€œhelloâ€ must be displayed in the HTML tag `DIV#hello`
-   You canâ€™t use `document.querySelector` to select the HTML tag
-   You must use the JQuery API
