# Project: 0x12. JavaScript - Warm up | ALX Africa Intranet
...
Write a script that prints â€œJavaScript is amazingâ€:
...
Write a script that prints two arguments passed to it, in the following format: â€œ is â€
...
Write a script that prints `x` times â€œC is funâ€
